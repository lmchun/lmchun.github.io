...
let systems;
function preload(){
img = loadImage('img/poppy.png'); // Load the image
}
...
//  this.acceleration = createVector(0, 0.05);
  ...
  //this.velocity = createVector(random(-0.1, 0.1), random(-0.1, 0));
...
Particle.prototype.display = function () {
  ...
  //this is where you put the image in
  image(img, this.position.x, this.position.y, width/3, height/3);
